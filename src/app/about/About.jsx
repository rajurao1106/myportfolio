...
export default function About() {
  ...
  useEffect(() => {
    // Animating the section header (ABOUT ME)
    gsap.fromTo(
      ".section-header",
      { opacity: 0, y: -50 },
    ...
    // Animating the personal info section
    gsap.fromTo(
      ".personal-info",
      { opacity: 0, x: -100 },
    ...
    // Animating the experience stats cards
    gsap.fromTo(
      ".stat-card",
      { opacity: 0, y: 50 },
      { opacity: 1, y: 0, duration: 1, ease: "bounce.out", stagger: 0.3, delay: 0.5 }
    );
  }, []);
